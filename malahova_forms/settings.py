...
CSRF_TRUSTED_ORIGINS = ['https://malahova.medblogers-base.ru', 'http://127.0.0.1']

ALLOWED_HOSTS = ["malahova.medblogers-base.ru", "127.0.0.1", "localhost"]
...
ROOT_URLCONF = 'malahova_forms.urls'
...
WSGI_APPLICATION = 'malahova_forms.wsgi.application'
